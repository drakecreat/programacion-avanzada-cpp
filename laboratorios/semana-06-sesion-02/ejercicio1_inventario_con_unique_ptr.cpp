...
unique_ptr<int[]>crearInventario(int cantidadProductos) {
    unique_ptr<int[]> stock (  new int[cantidadProductos]);
...
int main() {
    ...
    unique_ptr<int[]>stock = crearInventario(cantidadProductos);
    stock[0] = 10;
    stock[1] = 5;
    stock[3] = 8;
